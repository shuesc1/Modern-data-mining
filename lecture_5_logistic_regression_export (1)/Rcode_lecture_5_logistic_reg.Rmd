...
+ Chapter 4.1-4.3.4 (too skimpy about Logistic reg)
+ Chapter 20.1-20.5 (Statistical Sleuth, OK, not enough either)
...
&= \frac{1}{e^{\beta_0 + 130 \beta_1}}\cdot\frac{1}{e^{\beta_0 + 140\beta_1}}\cdots\frac{e^{\beta_0 + 130 \beta_1}}{1 + e^{\beta_0 + 130 \beta_1}} \dots
	\end{split}\]
...
- Are all the risk factors not useful? Or all the $\beta$'s are 0 (Other then the intercept)
```{r}
chi.sq <- 1469-1343
chi.sq  #126
```
...
Once again we don't have evidence to reject the null at 
...
- Extend models to include iterations
