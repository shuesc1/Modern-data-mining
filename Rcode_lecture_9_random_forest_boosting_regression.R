...
# Cons: The trees are correlated (on higher level). 
...
# 2) The recommended mtry for reg trees are mtry=p/3=19/3 about 6 or 7. Seems to agree with this 
#    example. Are you convinced with p/3?
...
# The following code verify that OOB errors seem to be 
# a good estimate of testing errors.
